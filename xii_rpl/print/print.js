(function webpackUniversalModuleDefinition(root, factory) {
  ...
  \**********************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _sass_index_scss__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
              /*! ./sass/index.scss */ "./src/sass/index.scss"
            );
          /* harmony import */ var _sass_index_scss__WEBPACK_IMPORTED_MODULE_0___default =
            /*#__PURE__*/ __webpack_require__.n(
              _sass_index_scss__WEBPACK_IMPORTED_MODULE_0__
            );
          /* harmony import */ var _js_init__WEBPACK_IMPORTED_MODULE_1__ =
  ...
  \*****************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _browser__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ./browser */ "./src/js/browser.js");
              ...
              if (
                ...
                if (styles.getPropertyValue(styles[key]))
                  elementStyle +=
                    styles[key] +
                    ":" +
                    styles.getPropertyValue(styles[key]) +
                    ";";
              }
          ...
          function addHeader(printElement, params) {
            ...
            printElement.insertBefore(
              headerContainer,
              printElement.childNodes[0]
            );
          }
          function cleanUp(params) {
            // If we are showing a feedback message to user, remove it
            if (params.showModal)
              _modal__WEBPACK_IMPORTED_MODULE_0__["default"].close(); // Check for a finished loading hook function

            if (params.onLoadingEnd) params.onLoadingEnd(); // If preloading pdf files, clean blob url

            if (params.showModal || params.onLoadingStart)
              window.URL.revokeObjectURL(params.printable); // Run onPrintDialogClose callback
  ...
  \************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          "use strict";
          __webpack_require__.r(__webpack_exports__);
          /* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ./functions */ "./src/js/functions.js");
          /* harmony import */ var _print__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ./print */ "./src/js/print.js");
          function _typeof(obj) {
            "@babel/helpers - typeof";
            if (
              typeof Symbol === "function" &&
          ...
          /* harmony default export */ __webpack_exports__["default"] = {
            print: function print(params, printFrame) {
              ...
              var printElement = isHtmlElement(params.printable)
                ? params.printable
                : document.getElementById(params.printable); // Check if the element exists

              if (!printElement) {
                window.console.error(
                  "Invalid HTML element id: " + params.printable
                );
                return;
          ...
          function cloneElement(element, params) {
            ...
            var childNodesArray = Array.prototype.slice.call(
              element.childNodes
            );
            ...
            if (params.scanStyles && element.nodeType === 1) {
              clone.setAttribute(
                "style",
                Object(
                  _functions__WEBPACK_IMPORTED_MODULE_0__["collectStyles"]
                )(element, params)
              );
  ...
  \*************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _print__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ./print */ "./src/js/print.js");
          /* harmony import */ var _browser__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(/*! ./browser */ "./src/js/browser.js");
  ...
  \************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          "use strict";
          __webpack_require__.r(__webpack_exports__);
          /* harmony import */ var _browser__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ./browser */ "./src/js/browser.js");
          /* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ./modal */ "./src/js/modal.js");
          /* harmony import */ var _pdf__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(/*! ./pdf */ "./src/js/pdf.js");
          /* harmony import */ var _html__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(/*! ./html */ "./src/js/html.js");
          /* harmony import */ var _raw_html__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(/*! ./raw-html */ "./src/js/raw-html.js");
          /* harmony import */ var _image__WEBPACK_IMPORTED_MODULE_5__ =
            __webpack_require__(/*! ./image */ "./src/js/image.js");
          /* harmony import */ var _json__WEBPACK_IMPORTED_MODULE_6__ =
            __webpack_require__(/*! ./json */ "./src/js/json.js");
          ...
          /* harmony default export */ __webpack_exports__["default"] = {
            init: function init() {
                ...
                case "object":
                  ...
                  params.fallbackPrintable =
                    typeof args.fallbackPrintable !== "undefined"
                      ...
                      : params.printable;
                  params.fallbackPrintable = params.base64
                  ...
                  for (var k in params) {
                    if (k === "printable" || k === "fallbackPrintable")
                      continue;
                    params[k] =
                      typeof args[k] !== "undefined" ? args[k] : params[k];
                  }
              ...
              if (!params.printable)
                throw new Error("Missing printable information."); // Validate type
              ...
              if (params.showModal)
                _modal__WEBPACK_IMPORTED_MODULE_1__["default"].show(params); // Check for a print start hook function
              ...
              if (params.type !== "pdf") {
                printFrame.srcdoc =
                  "<html><head><title>" + params.documentTitle + "</title>"; // Attach css files
  ...
  \************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony default export */ __webpack_exports__["default"] = {
            print: function print(params, printFrame) {
              ...
              params.properties = params.properties.map(function (property) {
                return {
                  field:
                    _typeof(property) === "object" ? property.field : property,
                  displayName:
                    _typeof(property) === "object"
                      ? property.displayName
                      : property,
                  columnSize:
                    _typeof(property) === "object" && property.columnSize
                      ? property.columnSize + ";"
          ...
          function jsonToHTML(params) {
            ...
            var htmlData =
              '<table style="border-collapse: collapse; width: 100%;">'; // Check if the header should be repeated
          ...
          var Modal = {
            show: function show(params) {
              ...
              var modalStyle =
                ...
                "transition: opacity .3s ease;"; // Create wrapper
  ...
  \***********************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var _print__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ./print */ "./src/js/print.js");
          /* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ./functions */ "./src/js/functions.js");
              ...
              params.printable = /^(blob|http|\/\/)/i.test(params.printable)
                ...
                : window.location.origin +
                  (params.printable.charAt(0) !== "/"
                    ? "/" + params.printable
                    : params.printable); // Get the file through a http request (Preload)
            ...
            send: function send(params, printFrame) {
              ...
              iframeElement.onload = function () {
                ...
                if (printDocument.document)
                  printDocument = printDocument.document; // Append printable element to the iframe body
