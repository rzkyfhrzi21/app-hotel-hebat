...
<head>
    <meta charset="utf-8">
    <title>Fasilitas - Hotel Hebat</title>
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="fasilitas.php" class="nav-item nav-link active">Fasilitas</a>
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="col-md-3">
                                    <div class="date" id="date2" data-target-input="nearest">
                                        <input type="text" name="check_out" class="form-control datetimepicker-input" placeholder="Check Out" data-target="#date2" data-toggle="datetimepicker"/>
                                    </div>
                                </div> -->
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-select" name="nama_kamar">
