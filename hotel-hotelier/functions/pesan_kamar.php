...
if (isset($_POST['pesan_kamar'])) {
    ...
    $query          = "INSERT into pemesanan set nama_pemesan = '$nama_pemesan', no_hp = '$no_hp', email = '$email', nama_tamu = '$nama_tamu', check_in = '$check_in', check_out = '$check_out', jumlah_kamar = '$jumlah_kamar', permintaan_khusus = '$permintaan_khusus', tipe_kamar = '$tipe_kamar'";
