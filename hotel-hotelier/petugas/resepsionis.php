      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
              <a href="?page=pesankamar" class="nav-link">
            ...
            <li class="nav-item">
              <a href="?page=pesananselesai" class="nav-link">
                <i class="nav-icon fas fa-book"></i>
                <p>
                  Pesanan Selesai
                </p>
    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="resepsionis.php">Resepsionis</a></li>
      ...
      <section class="content">
        ...
        if (@$_GET['page']) {
          switch ($_GET['page']) {
            case 'reservasi':
              include 'page/rsp_reservasi.php';
              break;
            case 'pesankamar':
              include 'page/rsp_pesankamar.php';
              break;
            case 'pesananselesai':
              include 'page/rsp_pesananselesai.php';
              break;
          }
        } else {
