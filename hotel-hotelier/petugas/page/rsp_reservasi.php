              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $sql_pemesanan = mysqli_query($koneksi, "SELECT * from pemesanan where status = '$status_pending'");
                        ...
                        <td>
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              <a href="../functions/pesanan_selesai.php?id=<?= $pemesanan['id_pemesanan']; ?>" class="dropdown-item">
                                Selesai
                              </a>
